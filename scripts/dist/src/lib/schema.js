        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    // Create a trigger to update the updated_at timestamp
                    _a.sent();
                    return [4 /*yield*/, db.exec("\n    CREATE TRIGGER IF NOT EXISTS update_neighborhoods_timestamp\n    AFTER UPDATE ON neighborhoods\n    BEGIN\n      UPDATE neighborhoods SET updated_at = CURRENT_TIMESTAMP WHERE id = NEW.id;\n    END;\n  ")];
                case 6:
                    _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [4 /*yield*/, db.exec('DROP TABLE IF EXISTS places')];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, db.exec('DROP TABLE IF EXISTS neighborhoods')];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, db.exec('DROP TABLE IF EXISTS place_types')];
                case 4:
                    _a.sent();
